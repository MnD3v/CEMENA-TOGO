    ...
    return (
        <section id="contact" className='my-8'>
            ...
            <div className='flex items-center justify-center'>
                ...
                <p className=' uppercase text-lg text-green-600 font-medium'>Contactez-nous</p></div>
            <div className='flex flex-wrap justify-center gap-3 m-3'>
                {contacts.map((element) => (
                    <motion.div
                        ...
                        whileInView="show"
                        viewport={{ once: true }}
                        key={element.icon} className='w-full sm:w-96
                         flex flex-col items-center p-4 
                        border border-green-400 bg-green-50 rounded-xl gap-3'>
                        ...
                        <a href={element.link} target='_blank' className='text-white font-bricolage px-6 py-4 bg-green-700 rounded-lg hover:bg-green-900 border border-white hover:ring ring-green-900'>{element.buttonText}</a>
                    </motion.div>
                ))}
            </div>
        </section>
